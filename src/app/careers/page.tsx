    ...
    <div className="section">
      <div className="container space-y-12">
        ...
        <header className="space-y-4">
          <p className="inline-flex items-center rounded-full border border-[#3194A0]/30 bg-[#3194A0]/5 px-3 py-1 text-[11px] font-medium text-[#3194A0]">
        ...
        <section className="grid gap-6 md:grid-cols-3 text-sm">
          <div className="rounded-2xl border border-[#3194A0]/25 bg-[#3194A0]/5 p-5 shadow-soft">
